...
: Our modifications:
: 
: 1.We added a single receptor conductance factor: "g_max=0.0012 (uS) from 0.000045 (uS)".
...
NEURON {
	...
	:RANGE tau1, tau2, tau3, e, i, g_max, g, k
...
PARAMETER {
	...
	tau2 = 27      (ms) <1e-9,1e9>	:decay time constant
	tau3 = 177 (ms) <1e-9,1e9> :2000     (ms) <1e-9,1e9>	    :decay time constant
	
	g_max= 0.000045 (uS) :	0.0012 (uS) 			: single channel conductance
	e    = 0 (mV)
	mg   = 1 (mM)
